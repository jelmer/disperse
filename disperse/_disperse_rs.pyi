...
def news_find_pending(tree, path: str) -> str | None: ...

def news_add_pending(tree, path: str, new_version: str) -> None: ...

def news_mark_released(tree, path: str, new_version, release_date) -> None: ...

class OddVersion(Exception): ...

def find_pending_version(tree, cfg) -> str | None: ...

def find_last_version(tree, cfg) -> tuple[str, str | None]: ...
